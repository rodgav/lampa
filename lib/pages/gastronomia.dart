...
import 'package:lampa/models/gastronomia.dart';
...
class GastronomiaPage extends StatefulWidget {
  ...
  GastronomiaPage({@required this.index});
...
class _GastronomiaPageState extends State<GastronomiaPage> {
  ...
  _createList() async {
    GastronomiaModel my_data =
    GastronomiaModel.fromJson(json.decode(await getJson()));
    gastronomia = my_data.gastronomia;
    setState(() {});
  }

  Future<String> getJson() {
    return rootBundle.loadString('assets/jsons/gastronomia.json');
  }
                ...
                gastronomia.length > 0
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ItemAtractivo(
                        ...
                        nombre: gastronomia[index].nombre,   distancia: '',
                        onTap: () => null);
                  },
