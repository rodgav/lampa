...
class DistritosPage extends StatefulWidget {
  int index;

  DistritosPage({@required this.index});

  @override
  _DistritosPageState createState() => _DistritosPageState();
}

class _DistritosPageState extends State<DistritosPage> {
  ...
  Future<String> getJson() {
    return rootBundle.loadString('assets/jsons/distritos.json');
  }
